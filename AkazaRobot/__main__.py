...
from AkazaRobot.modules import ALL_MODULES
from AkazaRobot.modules.helper_funcs.chat_status import is_user_admin
from AkazaRobot.modules.helper_funcs.misc import paginate_modules
...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(
            text="👥 SUPPORT", url="https://telegram.dog/AkazaRobotSupport"
        ),
