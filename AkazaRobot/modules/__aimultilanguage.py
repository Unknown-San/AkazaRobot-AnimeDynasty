...
from AkazaRobot import BOT_ID
from AkazaRobot.helper_extra.aichat import add_chat, get_session, remove_chat
from AkazaRobot.pyrogramee.pluginshelper import admins_only, edit_or_reply
from AkazaRobot import pbot as asuna
...
async def hmm(client, message):
    ...
    if chat_id in en_chats:
        ...
        test = test.replace("asuna", "Aco")
        URL = "https://api.affiliateplus.xyz/api/chatbot?message=hi&botname=@AkazaRobot&ownername=@The_Ghost_Hunter"
        ...
        # Kang with the credits bitches @InukaASiTHAkazaRobot
        test = test.replace("asuna", "Aco")
        test = test.replace("asuna", "Aco")
        URL = f"https://api.affiliateplus.xyz/api/chatbot?message={test}&botname=@AkazaRobot&ownername=@The_Ghost_Hunter"
        try:
            r = requests.request("GET", url=URL)
        except:
            return
