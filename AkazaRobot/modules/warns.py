...
import telegram
from AkazaRobot import TIGERS, WOLVES, dispatcher
from AkazaRobot.modules.disable import DisableAbleCommandHandler
from AkazaRobot.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from AkazaRobot.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from AkazaRobot.modules.helper_funcs.string_handling import split_quotes
from AkazaRobot.modules.log_channel import loggable
from AkazaRobot.modules.sql import warns_sql as sql
