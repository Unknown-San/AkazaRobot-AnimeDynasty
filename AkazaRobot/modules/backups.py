...
import AkazaRobot.modules.sql.notes_sql as sql
from AkazaRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from AkazaRobot.__main__ import DATA_IMPORT
from AkazaRobot.modules.helper_funcs.chat_status import user_admin
from AkazaRobot.modules.helper_funcs.alternate import typing_action

# from AkazaRobot.modules.rules import get_rules
import AkazaRobot.modules.sql.rules_sql as rulessql

# from AkazaRobot.modules.sql import warns_sql as warnssql
import AkazaRobot.modules.sql.blacklist_sql as blacklistsql
from AkazaRobot.modules.sql import disable_sql as disabledsql

# from AkazaRobot.modules.sql import cust_filters_sql as filtersql
# import AkazaRobot.modules.sql.welcome_sql as welcsql
import AkazaRobot.modules.sql.locks_sql as locksql
from AkazaRobot.modules.connection import connected
...
def export_data(update, context):
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("AkazaRobot{}.backup".format(chat_id), "rb"),
    ...
    os.remove("AkazaRobot{}.AkazaRobot".format(chat_id))  # Cleaning file
