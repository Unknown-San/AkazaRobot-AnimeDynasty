...
import AkazaRobot.modules.sql.global_bans_sql as gban_sql
import AkazaRobot.modules.sql.users_sql as user_sql
from AkazaRobot import DEV_USERS, OWNER_ID, dispatcher
